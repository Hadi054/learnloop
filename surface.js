...
const SUR = {
...

  {
    ...
    "build": {
      "design": {
        "svg": "<svg viewBox='0 0 360 214' xmlns='http://www.w3.org/2000/svg' role='img' aria-label='PixelRuler: a one point line above a one pixel line, both labelled with their formula, above a readout the view prints itself'><g font-family='ui-monospace,monospace' font-size='11'>\n<rect x='10' y='10' width='340' height='194' rx='6' fill='none' stroke='var(--line)'/>\n<text x='24' y='30' fill='var(--dim)'>PixelRuler</text>\n\n<text x='24' y='63' fill='var(--amber)'>1 pt</text>\n<rect x='72' y='55' width='166' height='3' fill='var(--amber)'/>\n<text x='250' y='63' fill='var(--dim)'>= scale px</text>\n\n<text x='24' y='95' fill='var(--cyan)'>1 px</text>\n<rect x='72' y='92' width='166' height='1' fill='var(--cyan)'/>\n<text x='250' y='95' fill='var(--dim)'>= 1.0/scale</text>\n\n<text x='72' y='116' fill='var(--green)' font-size='10'>the two must look different to your eye</text>\n\n<rect x='24' y='130' width='312' height='62' rx='4' fill='none' stroke='var(--line)' stroke-dasharray='3 3'/>\n<text x='36' y='150' fill='var(--text)'>displayScale</text>\n<text x='146' y='150' fill='var(--amber)'>traitCollection</text>\n<text x='36' y='167' fill='var(--text)'>bounds</text>\n<text x='146' y='167' fill='var(--dim)'>pt</text>\n<text x='36' y='184' fill='var(--text)'>nativeBounds</text>\n<text x='146' y='184' fill='var(--dim)'>px</text>\n<text x='214' y='184' fill='var(--green)' font-size='10'>printed, not typed</text>\n</g></svg>",
        "caption": "What PixelRuler shows: one point above one pixel, each thickness derived from the scale rather than typed, and the three numbers printed by the view itself."
      },
...

  {
    ...
    "build": {
      "design": {
        "svg": "<svg viewBox='0 0 360 244' xmlns='http://www.w3.org/2000/svg' role='img' aria-label='StatefulButton: five rows — normal, highlighted, disabled, selected and loading — each with its own wording and raw value'><g font-family='ui-monospace,monospace' font-size='11'>\n<rect x='10' y='10' width='340' height='224' rx='6' fill='none' stroke='var(--line)'/>\n<text x='24' y='30' fill='var(--dim)'>StatefulButton</text>\n<text x='240' y='30' fill='var(--dim)' font-size='10'>rawValue</text>\n\n<text x='24' y='62' fill='var(--text)'>normal</text>\n<rect x='104' y='47' width='112' height='22' rx='5' fill='var(--amber)'/>\n<text x='160' y='62' fill='#1A1608' text-anchor='middle'>Save</text>\n<text x='250' y='62' fill='var(--dim)'>0</text>\n\n<text x='24' y='94' fill='var(--text)'>highlighted</text>\n<rect x='104' y='79' width='112' height='22' rx='5' fill='var(--amber-dim)'/>\n<text x='160' y='94' fill='#1A1608' text-anchor='middle'>Save</text>\n<text x='250' y='94' fill='var(--dim)'>1</text>\n\n<text x='24' y='126' fill='var(--text)'>disabled</text>\n<rect x='104' y='111' width='112' height='22' rx='5' fill='none' stroke='var(--dim)' stroke-dasharray='3 3'/>\n<text x='160' y='126' fill='var(--dim)' text-anchor='middle'>Unavailable</text>\n<text x='250' y='126' fill='var(--dim)'>2</text>\n\n<text x='24' y='158' fill='var(--text)'>selected</text>\n<rect x='104' y='143' width='112' height='22' rx='5' fill='none' stroke='var(--green)'/>\n<text x='160' y='158' fill='var(--green)' text-anchor='middle'>Saved</text>\n<text x='250' y='158' fill='var(--dim)'>4</text>\n\n<text x='24' y='190' fill='var(--cyan)'>loading</text>\n<rect x='104' y='175' width='112' height='22' rx='5' fill='none' stroke='var(--cyan)'/>\n<text x='160' y='190' fill='var(--cyan)' text-anchor='middle'>Saving...</text>\n<text x='240' y='190' fill='var(--cyan)' font-size='10'>yours to model</text>\n\n<text x='24' y='218' fill='var(--green)' font-size='10'>every row 44 pt tall - printed and checked, not assumed</text>\n</g></svg>",
        "caption": "Five rows you write on purpose. The disabled row says something different from the normal row, and loading is not a UIControl.State at all — you model it."
      },
