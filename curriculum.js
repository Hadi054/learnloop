  ...
  },
  {
   ...
   "loops": [
    ...
    },
    {
     ...
     "transfer": "Pull two git revisions of one of the work app's `.proto` files and diff them. Classify every change with this loop's verdicts — SAFE / BREAKS / LANDMINE — and check `reserved` discipline on anything deleted. If history contains a renumber or retype, trace what actually happened downstream; that archaeology is the best compatibility lesson your codebase can offer.",
    ...
    },
    {
     ...
     "concept": {
      ...
      "whyItMatters": "Your work app's dozens of in-flight gRPC calls ride one TCP connection as interleaved streams — that's why Charles shows a single connection with many exchanges. \"Why does gRPC require HTTP/2?\" is simultaneously an interview classic and the literal architecture of your day job."
     },
     "exercise": {
